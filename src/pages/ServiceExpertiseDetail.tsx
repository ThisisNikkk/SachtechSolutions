...
import { serviceExpertise } from '@/data/serviceExpertise';
...
const ServiceExpertiseDetail: React.FC<ServiceExpertiseDetailProps> = ({ onNavigate }) => {
    const { slug, expertiseSlug } = useParams<{ slug: string; expertiseSlug: string }>();
    ...
    const expertiseList = serviceExpertise[slug || ''];
    const expertiseItem = expertiseList?.find(
        (item) => item.id.toLowerCase().replace(/[^a-z0-9]+/g, '-') === expertiseSlug
    );
        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow">
                <div className="container mx-auto px-4 py-16 lg:py-24">
                    ...
                    {expertiseItem.content?.map((section, idx) => (
...
export default ServiceExpertiseDetail;
